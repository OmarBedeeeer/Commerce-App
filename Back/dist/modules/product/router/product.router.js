...
router.post("/:subCategoryId/create-product", user_auth_1.authentecation, (0, user_auth_1.authorized)("admin"), (0, multer_1.getUploadMiddleware)("img", 5), product_validation_1.createProductValidation, product_controller_1.productController.createProduct);
